...
var Stats = function () {
  ...
  var meanMSPanel = addPanel(new Stats.Panel("mean", "#0ff", "#002"));
  var stdevPanel = addPanel(new Stats.Panel("std", "#0f0", "#020"));
  var msPanel = addPanel(new Stats.Panel("ms", "#f08", "#201"));
  ...
  return {
    ...
    begin: function () {
      ...
      meanMSPanel.update(mean_ft, 100);
      stdevPanel.update(running_std_deviation, 100);
...
Stats.Panel = function (name, fg, bg) {
  ...
  return {
    ...
    update: function (value, maxValue) {
      ...
      context.fillStyle = fg;
      context.fillText(
        name + ":" + value + " (" + round(min) + "-" + round(max) + ")",
        TEXT_X,
        TEXT_Y,
      );
